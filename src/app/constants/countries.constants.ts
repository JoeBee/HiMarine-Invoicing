export const COUNTRIES = [
    ...
    'Colombia', 'Croatia', "Côte d'Ivoire", 'Cyprus', 'Czech Republic', 'Denmark', 'Ecuador',
    'Egypt', 'Estonia', 'Finland', 'France', 'Georgia', 'Germany', 'Gibraltar', 'Ghana',
    ...
    'Malta', 'Mexico', 'Morocco', 'Mozambique', 'Namibia', 'Netherlands', 'New Zealand', 'Nigeria',
...
export const COUNTRY_PORTS: { [key: string]: string[] } = {
    ...
    'Canada': ['Prince Rupert', 'Vancouver', 'Montreal', 'Halifax', 'Toronto', 'Thunder Bay', 'Saint John', 'Hamilton', 'Quebec City'],
    ...
    'Guatemala': ['Puerto Quetzal', 'Santo Tomás de Castilla', 'Puerto Barrios', 'Puerto San José', 'Champerico'],
    ...
    'Panama': ['Balboa', 'Cristobal', 'Colon', 'Panama City', 'Manzanillo'],
    ...
    "Côte d'Ivoire": ['Abidjan', 'San-Pédro', 'Sassandra'],
